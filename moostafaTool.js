...
// @version       0.2
// @description   Unlocks all possible items in the upgrade bar (Library Version)
// @author        Varkyz
// @match         *://moomoo.io/*
// @match         *://*.moomoo.io/*
...
(function() {
    if (!window.Moostafatool) {
        window.Moostafatool = {};
    }

    window.Moostafatool.ItemMore = (function() {
        const {
            msgpack
        } = window;
        const PACKETCODE = {
        ...
        return {
            ...
            items: items,
            utils: UTILS,
            packetCodes: PACKETCODE
        };
    })();

    // Initialize the library automatically
    window.Moostafatool.ItemMore.init();
})();
